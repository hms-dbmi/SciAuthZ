...
# Set app parameters
ENV DBMI_PARAMETER_STORE_PREFIX=dbmi.authz.${DBMI_ENV}
ENV DBMI_PARAMETER_STORE_PRIORITY=true
ENV DBMI_AWS_REGION=us-east-1

# App config
ENV DBMI_APP_ROOT=/app
ENV DBMI_APP_DOMAIN=authorization.dbmi.hms.harvard.edu
...
CMD gunicorn dbmiauthz.wsgi:application -b 0.0.0.0:${DBMI_GUNICORN_PORT} \
